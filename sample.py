...
engine = 'cuda_graphs' # which inference engine to use (see inference/ folder)
...
print(f"Using inference engine: {engine}")
Engine = inference.get_engine(engine)
inference_engine = Engine(model)
